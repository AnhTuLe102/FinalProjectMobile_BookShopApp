...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse save(Product theProduct) {
        ...
        try {
            ...
            response.setError(false);
            response.setMessage("Saved product id - " + theProduct.getId());
        } catch (Exception e) {
            response.setError(true);
    ...
    @Override
    public List<Product> findByBookTypeId(int bookTypeId) {
        return productRepository.findByBookTypeId(bookTypeId);
    }
}
